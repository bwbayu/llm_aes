...
from src.data.truncateDataset import TruncateDataset
...
class BertTruncatePipeline:
    ...
    def create_dataset(self, train_dataset, valid_dataset, test_dataset):
        ...
        train_data = TruncateDataset(train_dataset, self.tokenizer, self.config['max_seq_len'])
        valid_data = TruncateDataset(valid_dataset, self.tokenizer, self.config['max_seq_len'])
        test_data = TruncateDataset(test_dataset, self.tokenizer, self.config['max_seq_len'])
