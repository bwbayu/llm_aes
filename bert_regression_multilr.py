...
df_result = None
if os.path.exists("experiments/results/new_dataset_mix_bert_multilr.csv"):
    df_result = pd.read_csv("experiments/results/new_dataset_mix_bert_multilr.csv")
    print(df_result['config_id'].iloc[-1])
else:
    print("File 'new_dataset_mix_bert_multilr.csv' does not exist.")
...
if os.path.exists("experiments/results/new_dataset_mix_bert_multilr_epoch.csv"):
    df_result1 = pd.read_csv("experiments/results/new_dataset_mix_bert_multilr_epoch.csv")
    print(max(df_result1['valid_pearson']))
else:
    print("File 'new_dataset_mix_bert_multilr_epoch.csv' does not exist.")
...
logging.info(
    ...
    f", batch_size={8}, epochs={24}, learning_rate_backbone={2e-5}, learning_rate_head={1e-3}"
)
...
try:
    ...
    results_path = os.path.join(ROOT_DIR, "experiments/results/new_dataset_mix_bert_multilr.csv")
    results_epoch_path = os.path.join(ROOT_DIR, "experiments/results/new_dataset_mix_bert_multilr_epoch.csv")
