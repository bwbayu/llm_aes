...
df_result = None
if os.path.exists("experiments/results/new_dataset_mix_sindobert.csv"):
    df_result = pd.read_csv("experiments/results/new_dataset_mix_sindobert.csv")
    print(df_result['config_id'].iloc[-1])
else:
    print("File 'new_dataset_mix_sindobert.csv' does not exist.")
...
if os.path.exists("experiments/results/new_dataset_mix_sindobert_epoch.csv"):
    df_result1 = pd.read_csv("experiments/results/new_dataset_mix_sindobert_epoch.csv")
    print(max(df_result1['valid_pearson']))
else:
    print("File 'new_dataset_mix_sindobert_epoch.csv' does not exist.")
...
try:
    ...
    results_path = os.path.join(ROOT_DIR, "experiments/results/new_dataset_mix_sindobert.csv")
    results_epoch_path = os.path.join(ROOT_DIR, "experiments/results/new_dataset_mix_sindobert_epoch.csv")
